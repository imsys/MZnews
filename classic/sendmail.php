...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt" lang="pt">
	<head>
		<title>MZn² 2.0 ADV - Enviar notícia por e-mail</title>
<style type="text/css">
<!--
...
/* Botão de envio */
button {font-family:Tahoma, Verdana, Arial, Helvetica, sans-serif; font-size:8pt; }
...
$mzn_path = dirname(__FILE__); $mzn_path = str_replace("/classic:EOF:", "", $mzn_path .":EOF:"); $mzn_path = str_replace("\\classic:EOF:", "", $mzn_path .":EOF:"); $mzn_path = str_replace(":EOF:", "", $mzn_path); require_once($mzn_path ."/mzn2.php");
...
if (!$acao) {
	...
	$mzn2->mostrar_formulario_email("acao=enviar", "fechar");
	echo "</div>";
}
else if ($acao == "enviar") {
